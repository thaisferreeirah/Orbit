...
{
    public class Comunidade(int codigo, string nome, string foto, string descricao)
    {
    ...
    public class ComunidadeManager
    {
        ...
        public void AdicionarComunidade(int codigo, string nome, string foto, string descricao)
        {
            Comunidade novaComunidade = new Comunidade(codigo, nome, foto, descricao);
            //Comunidade.Add();
